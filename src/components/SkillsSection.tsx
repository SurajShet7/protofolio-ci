...
const bentoCategories = [
  {
    ...
    items: ['AWS', 'Microsoft Azure', 'Virtualization', 'Containerization'],
    description: 'Specialized in deploying, configuring, and managing highly available, scalable, and fault-tolerant cloud infrastructures.',
    stat: 'CLOUD-FIRST',
  ...
  },
  {
    ...
    badge: 'AUTOMATION',
    items: ['CI/CD', 'Docker', 'Automation Scripts', 'Bash/Linux'],
    description: 'Streamlining software delivery workflows through robust deployment pipelines, virtualization, and infrastructure automation.',
    stat: 'CI/CD DRIVEN',
  ...
  },
  {
    ...
    badge: 'LOGIC',
    items: ['Python', 'C++', 'HTML', 'Java'],
    description: 'Strong analytical foundation in software development and scripting languages, enabling robust automation and custom tooling.',
    stat: 'ALGORITHMIC',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'DATA LAYERS',
    items: ['MySQL', 'PostgreSQL', 'Relational Databases'],
    description: 'Designing clean relational database schemas, writing optimized SQL queries, and managing data integrity across environments.',
    stat: 'ACID INTEGRITY',
    colSpan: 'lg:col-span-7',
  },
];
