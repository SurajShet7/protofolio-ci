        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Suraj C Shet</span>, a Master of Computer Applications (MCA) student specializing in Cloud Computing and DevOps. With a strong foundation in programming, databases, and containerization, I build scalable systems, automate CI/CD pipelines, and manage cloud environments with clean, automated, and high-performance infrastructure.
            </motion.p>
