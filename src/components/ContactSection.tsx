        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              {/* Direct Channels */}
              <div 
                className="space-y-4 pt-6 border-t border-[#8C6D4F]/25 max-w-sm"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                <div className="flex flex-col">
                  <span className="text-[9px] font-mono tracking-[0.25em] text-[#8C6D4F] uppercase mb-1">// DIRECT CHANNELS</span>
                  <a href="mailto:surajcshet5@gmail.com" className="text-xs text-[#E8DFD8] hover:text-[#D4AF37] transition-colors py-1">
                    ✉ surajcshet5@gmail.com
                  </a>
                  <a href="tel:9611129085" className="text-xs text-[#E8DFD8] hover:text-[#D4AF37] transition-colors py-1">
                    ☎ +91 9611129085
                  </a>
                </div>

                <div className="flex flex-col">
                  <span className="text-[9px] font-mono tracking-[0.25em] text-[#8C6D4F] uppercase mb-1">// ENCRYPTED LINK</span>
                  <a 
                    href="https://linkedin.com/in/suraj-c" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="text-xs text-[#E8DFD8] hover:text-[#D4AF37] transition-colors py-1"
                  >
                    ↗ linkedin.com/in/suraj-c
                  </a>
                </div>

                <div className="flex flex-col">
                  <span className="text-[9px] font-mono tracking-[0.25em] text-[#8C6D4F] uppercase mb-1">// COORDS</span>
                  <span className="text-xs text-[#A8988B] py-1">
