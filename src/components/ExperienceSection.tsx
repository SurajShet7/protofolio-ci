...
const journey: RouteStop[] = [
  {
    id: '01',
    year: '05/2026 - 07/2026',
    title: 'PROJECT DEVELOPER INTERN',
    organization: 'LARSEN & TOUBRO',
    description: 'Responsible for designing, developing, testing, and maintaining software applications based on project requirements.',
  },
  {
    id: '02',
    year: '11/2025 - 12/2025',
    title: 'UI/UX DESIGN INTERN',
    organization: 'COGNIFYZ TECHNOLOGIES',
    description: 'Collaborated on user interface design principles and layout structure, ensuring that digital interfaces are user-friendly, responsive, and visually cohesive.',
  },
  {
    id: '03',
    year: '08/2024 - 06/2026',
    title: 'MASTER OF COMPUTER APPLICATIONS (MCA)',
    organization: 'S VYASA DEEMED TO BE UNIVERSITY',
    description: 'Specializing in Cloud Computing. Gained deep knowledge of distributed systems, server configurations, and database management. Current CGPA: 7.67.',
  },
  {
    id: '04',
    year: '05/2024 - 07/2024',
    title: 'CLOUD & DEVOPS INTERN',
    organization: 'UTL TECHNOLOGY LTD (APPLICATION DEVELOPMENT)',
    description: 'Assisted with the deployment and management of scalable cloud systems. Supported the implementation of automation scripts, virtualization, and CI/CD pipelines.',
  },
  {
    id: '05',
    year: '10/2021 - 09/2024',
    title: 'BACHELOR OF COMPUTER APPLICATIONS (BCA)',
    organization: 'PINNACLE INSTITUTE MANAGEMENT AND SCIENCE',
    description: 'Foundational studies in programming, database management systems, and web technologies. Graduated with a CGPA of 7.90.',
  },
  {
    id: '06',
    year: '08/2019 - 05/2021',
    title: 'PRE-UNIVERSITY COLLEGE (PUC)',
    organization: 'INTERNATIONAL VASAVI PU COLLEGE',
    description: 'Completed pre-university education with a focus on core academic subjects, graduating with an aggregate of 61%.',
  },
];
