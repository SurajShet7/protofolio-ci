...
const projects: Project[] = [
  {
    ...
    metrics: [
      { label: 'STRATEGY', value: 'Carbon-Aware Workloads' },
      { label: 'TARGET', value: 'Minimize Carbon Footprint' },
      { label: 'OPERATIONS', value: 'Dynamic Task Migrations' },
    ],
  },
  {
    number: '02',
    ...
    metrics: [
      { label: 'CAPABILITY', value: 'Telemedicine & EHR' },
      { label: 'SCHEDULING', value: 'Real-time Booking' },
      { label: 'IMPACT', value: 'Reduced Wait Times' },
    ],
  },
];
